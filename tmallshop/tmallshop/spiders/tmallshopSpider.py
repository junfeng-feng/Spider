...
#     name = 'tmallshopFromUrl'
#     
#     allowed_domain = ['tmall.com']
#     start_urls = []
# 
#     i = 0
#     for shopUrl in file("tmallshop/spiders/shopUrl.list"):
#         shopUrl = shopUrl.strip()
#         if len(shopUrl) < 5:
#             continue
#         start_urls.append(shopUrl)
# #         i+=1
# #         if i > 2 :
# #             break
#         
...
#         
#         item = TmallshopItem()
#         item["shop_id"] = select.xpath(".//input[@id='dsr-userid']/@value").extract()[0].strip()
#         try:
#             item["brand_id"] = select.css(".j_CollectBrandNum::attr(data-brandid)").extract()[0]
#         except Exception, e:
#             item["brand_id"] = ""
#             print e
#         item["shop_logo"] = ""
...
#         # 获取描述，服务，物流数据
#         liResult = []
#         liList = select.css(".shop-rate").xpath(".//li")
#         for li in liList:
#             score = ""
#             compareScore = ""
#             b = li.xpath(".//b").extract()[0]
#             if b.find("fair"):
#                 compareScore = "持平 --------"
#             elif b.find("lower"):
#                 compareScore = "低于 "
...
#                 compareScore = "高于 "
#                 
#             emList = li.xpath(".//em/text()").extract()
#             # print emList
#             score = emList[0]
#             compareScore = compareScore + str(emList[1])
#             liResult.append((score, compareScore))
#             pass
#         
#         item["description_consist_score"] = liResult[0][0].strip()
#         item["description_consist_cmp"] = liResult[0][1].strip()
#         item["service_attitude_score"] = liResult[1][0].strip()
#         item["service_attitude_cmp"] = liResult[1][1].strip()
#         item["logistics_service_score"] = liResult[2][0].strip()
#         item["logistics_service_cmp"] = liResult[2][1].strip()
#         
#         
#         # 获取店铺名，公司名，开店时间，地址
#         liResult = []
#         liList = select.css(".extend").xpath(".//li")
#         for li in liList:
#             html = li.extract()
#             if html.find("掌") != -1:  # "掌柜"
#                 item["shop_name"] = li.xpath(".//a/text()").extract()[0].strip()
#             elif html.find("开店时长") != -1:
#                 item["open_years"] = li.xpath(".//div/span/text()").extract()[1].strip()
#                 pass
#             elif html.find("司") != -1:  # 公司名
#                 item["company_name"] = li.xpath(".//div/text()").extract()[0].strip()
#                 pass
#             elif html.find("地") != -1:  # 所在地
#                 item["shop_area"] = li.xpath(".//div/text()").extract()[0].strip()
#                 pass
#             elif html.find("") != -1:
#                 pass
#             pass
